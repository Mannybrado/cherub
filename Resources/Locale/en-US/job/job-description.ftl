...
job-description-hop = Maintain the honor of the State. Direct rebuilding efforts aboard the station.
...
job-description-security = Catch criminals, enforce the Maritime law, and ensure that the sector does not fall into disarray.
...
job-description-senior-officer = Teach new Minutemen the basics of searches, performing arrests, prison times and how to properly shoot a firearm.
